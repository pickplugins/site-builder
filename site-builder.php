...
class SiteBuilder{
	...
	public function admin_scripts(){
        ...
        wp_enqueue_style('site-builder', QA_PLUGIN_URL.'assets/admin/css/site-builder.css');
        wp_enqueue_style('bootstrap', QA_PLUGIN_URL.'assets/global/css/bootstrap.css');
        wp_enqueue_style('fontawesome.min', QA_PLUGIN_URL.'assets/global/css/fontawesome.min.css');
